...
Out-of-the-box LAMP image (PHP+MySQL+BonitaBPM)

Bonita details from here: https://hub.docker.com/_/bonita/

Usage
-----

To create the image `docker-bonita-lamp`, execute the following command on the tutum-docker-lamp folder:

	docker build -t bonita-lamp-docker .

You can now push your new image to the registry:

	docker push bonita-lamp-docker
...
Start your image binding the external ports 80 and 3306 in all interfaces to your container:
	...
	docker run -d -p 80:80 -p 3306:3306 -p 8080:8080 bonita-lamp-docker
...
Shutting Down and Removing Your Docker image
--------------------------------------------
